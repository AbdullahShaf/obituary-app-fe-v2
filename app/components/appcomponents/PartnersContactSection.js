  ...
  return (
    <div className="w-full bg-white pt-[124px] pb-[130px] flex flex-col items-center gap-12">
      <div className="w-full max-w-5xl mx-auto flex flex-col gap-[2px] items-center">
        <h2 className="text-[#3C3E41] font-normal text-[40px] leading-[48px] mb-6">
          Sodelujmo!
        </h2>
      ...
      <button className="bg-gradient-to-b from-[#0D94E8] to-[#1860A3] shadow-md shadow-lg border border-[#0A85C2] w-[250px] h-[52px] rounded-[50px] text-white">
        Pišite nam
      </button>
    </div>
  );
