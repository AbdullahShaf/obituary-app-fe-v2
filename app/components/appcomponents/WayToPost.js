    ...
    return (
        <div className="relative bg-[#D4E6F9] desktop:h-[485px] tablet:h-[805px]">
            <div className="relative max-w-[1920px]  w-full flex mx-auto justify-center items-center">
                <div className="relative  desktop:max-w-[1184px] desktop:px-[20px] desktop:w-full tablet:w-full mx-auto tablet:h-[850px] mobile:h-[690px] h-[539.34px] flex flex-col items-center ">

                    <div className="relative  tablet:h-[799px] mobile:h-[690px] w-full flex desktop:flex-row flex-col">
                        ...
                        tablet:mt-[75px] mobile:mt-[50px] flex flex-col mobile:items-center tablet:items-center">
                            ...
                            <h2 className="text-[#3C3E41] font-bold text-[24px] tablet:text-[22px] mobile:text-[20px] leading-[48px] tablet:leading-[30px] mobile:leading-[28px] mt-[5px] tablet:text-center mobile:text-center">Toplejši način objavljanja osmrtnic</h2>

                            <p className="mt-[42px] text-[#3C3E41] tablet:text-center mobile:text-center mobile:mt-[22px] mobile:px-[20px] text-[18px] leading-[27px] font-variation-customOpt18">
                            ...
                            <p className="mt-[28px] text-[#3C3E41] tablet:text-center mobile:text-center mobile:mt-[22px] px-[2px] text-[18px] leading-[27px] font-variation-customOpt18">
